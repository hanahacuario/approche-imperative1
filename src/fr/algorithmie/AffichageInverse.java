...
public class AffichageInverse {
	...
	public static void main(String[] args) {
		...
		// arrayCopy
		String newTableau = "l’ensemble des éléments du tableau arrayCopy ";
		System.out.println(newTableau);
		System.out.println("-------------------------------------");
		int[] arrayCopy = new int[tableauArray.length];
		for (int i = 0; i < longtab; i++) {
			arrayCopy[i] = tableauArray[i];
			// Afficher arrayCopy tableau
